...
const Footer = () => {
  return (
    <footer className="bg-[#57b0f8] dark:bg-gray-800 text-gray-800 dark:text-white p-8 mt-auto">
        ...
        <div>
          ...
          <form>
            <input
              type="text"
              placeholder="Name"
              className="w-full p-2 mb-4 bg-gray-300 dark:bg-gray-700 text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-gray-400 dark:border-gray-600 rounded"
            />
            <input
              type="email"
              placeholder="Email"
            ...
            <button
              type="submit"
              className="bg-[#B37201] dark:bg-[#B37201] text-white py-2 px-4 rounded hover:bg-[#925a00] dark:hover:bg-[#925a00]"
            >
              Send Message
            </button>
          </form>
      ...
      <div className="border-t border-gray-400 dark:border-gray-700 mt-8 pt-4 text-center">
